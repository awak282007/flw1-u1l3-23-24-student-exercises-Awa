...
let creatureDescription = "creature-description";
...
let visitorAge = Math.floor(Math.random(15) * 60) + 1;
...
let zooSummary = "Welcome to the magical zoo! Our magical creature is " + creatureName + ". " + creatureDescription + ". " + "It is " + isFriendly + " that it is friendly to humans. " + "It is " + canVisit + " that you can visit it. " + "It is " + visitorAge + " years old.";
